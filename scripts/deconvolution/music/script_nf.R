...
eset_obj_visium <- Biobase::ExpressionSet(assayData=as.matrix(synthetic_visium_data$counts))

# cat("Running deconvolution tool...\n")
# start_time <- Sys.time()
# music_deconv = MuSiC::music_prop(bulk.eset = eset_obj_visium, sc.eset = eset_obj_scRNA,
